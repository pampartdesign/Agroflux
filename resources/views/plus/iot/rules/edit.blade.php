...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-semibold text-slate-900">Edit Rule</h1>
        <p class="text-sm text-slate-500 mt-1">Update <span class="font-medium text-slate-700">{{ $rule->name }}</span></p>
    </div>
...
@include('plus.iot.rules._form', [
    'action' => route('plus.iot.rules.update', $rule),
    'method' => 'PUT',
])
